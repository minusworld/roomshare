...
config = {
    ...
    "company_name": os.environ.get('company_name', "Star Nomad Digital, LLC"),
    "contact_email": os.environ.get('contact_email', "grayson@starnomaddigital.com")
}
...
def _send_email(uid, name, email):
    ...
    message['To'] = email
    message.set_content(
        render_template("email.email", name=name, delete_link=delete_link)
    )
